...
configure_wordpress() {
    ...
    wp core install --url=wpgraphql.test --title="WPGraphQL Meta Query Tests" --admin_user=admin --admin_password=password --admin_email=admin@wpgraphql.test
...
activate_plugins() {
    ...
    ln -s $PLUGIN_DIR $WP_CORE_DIR/wp-content/plugins/wp-graphql-meta-query

    cd $WP_CORE_DIR

    # activate the plugin
    wp plugin activate wp-graphql
    wp plugin activate wp-graphql-meta-query
